...
describe('Actions', () => {
  ...
  it('should show only current reservations when one is deleted', () => {
    cy.get('.resy-form').children().first()
      .focus('.name-input')
      .type('elsa the unicorn')
      .next().focus('date-input')
      .type('2021-12-25')
      .next().focus('time-input')
      .type('11:11')
    ...
    cy.get('.resy-container').children()
      ...
      .find('button')
      .click()
      .get('div:last').children('p:first')
      .should('not.have.text', 'elsa the unicorn')
      .next()
      .should('not.have.text', '2021-12-25')
      .next()
      .should('not.have.text', '11:11')
      .next()
      .should('not.have.text', '42')
  })
